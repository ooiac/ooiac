...
| [`42_milestone_5`](https://github.com/ooiac/42_milestone_5) | Inception (Docker, from-scratch WordPress/Nginx/MariaDB stack + bonuses), webserv (non-blocking HTTP/1.1 server in C++98, CGI + sessions bonuses), CPP modules 5-9 | complete |
---
### stack
```
languages   C  ·  C++  ·  Bash
